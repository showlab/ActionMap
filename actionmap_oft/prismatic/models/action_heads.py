...
from actionmap.heatmap_action_head import HeatmapActionHead as ActionMapHeatmapActionHead
...
class HeatmapActionHead(ActionMapHeatmapActionHead):
    """
    ActionMap voxel action heatmap head, bound to this codebase's action constants.

    See `actionmap.heatmap_action_head.HeatmapActionHead` for the implementation.
    """

    def __init__(self, input_dim=4096, hidden_dim=4096, action_dim=ACTION_DIM, **kwargs):
        super().__init__(
            input_dim=input_dim,
            hidden_dim=hidden_dim,
